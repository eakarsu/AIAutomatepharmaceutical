...
// v0 scaffold for: No e-signature workflow
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-e-signature-workflow/run.

export default function ESignatureWorkflowPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-e-signature-workflow/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No e-signature workflow</h1>
