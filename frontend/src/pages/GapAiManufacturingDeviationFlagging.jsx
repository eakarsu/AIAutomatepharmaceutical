...
// v0 scaffold for: No AI manufacturing-deviation flagging
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-manufacturing-deviation-flagging/run.

export default function AiManufacturingDeviationFlaggingPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-manufacturing-deviation-flagging/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI manufacturing-deviation flagging</h1>
