...
// v0 scaffold for: No regulatory-submission preparation (CTD format)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-regulatory-submission-preparation-ctd-format/run.

export default function RegulatorySubmissionPreparationCtdFormatPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-regulatory-submission-preparation-ctd-format/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No regulatory-submission preparation (CTD format)</h1>
