...
// v0 scaffold for: FDA eSTAR, EMA gateway, and regulatory-database connectors
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-fda-estar-ema-gateway-regulatory/run.

export default function FdaEstarEmaGatewayRegulatoryPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-fda-estar-ema-gateway-regulatory/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>FDA eSTAR, EMA gateway, and regulatory-database connectors</h1>
