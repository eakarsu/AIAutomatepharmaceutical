...
// v0 scaffold for: No collaboration / commenting threads
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-collaboration-commenting-threads/run.

export default function CollaborationCommentingThreadsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-collaboration-commenting-threads/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No collaboration / commenting threads</h1>
