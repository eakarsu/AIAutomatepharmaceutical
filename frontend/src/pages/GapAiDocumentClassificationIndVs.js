...
// v0 scaffold for: No AI document classification (IND vs. NDA vs. BLA)
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-document-classification-ind-vs/run.

export default function AiDocumentClassificationIndVsPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-document-classification-ind-vs/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI document classification (IND vs. NDA vs. BLA)</h1>
